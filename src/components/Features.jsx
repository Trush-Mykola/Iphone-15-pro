...
const Features = () => {
  ...
  useGSAP(() => {
    ...
    animateWithGsap(".g_text", { y: 0, opacity: 1, ease: "power2.inOut", duration: 0.8 });
  }, []);
              ...
              <div className="feature-text-container">
                <div className="flex-1 flex-center">
                  <p className="feature-text g_text">
                    iPhone 15 pro is {""}
                    <span className="text-white">the first iPhone to feature an aerospace-grade titanium design</span>, using the same alloy that spacecraft use for missions yo
                    Mars.
                  </p>
                </div>
                <div className="flex-1 flex-center">
